  ...
  return (
    <div className="pt-20">
      ...
      <section className="relative py-16 sm:py-24 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(600px,90vw)] h-[min(400px,60vw)] bg-blue-600/10 rounded-full blur-[100px]" />

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-blue-500/20 text-sm text-blue-300 mb-6 sm:mb-8"
          >
            <Zap size={14} />
          ...
          <motion.p
            ...
            className="text-base sm:text-xl text-slate-400 max-w-3xl mx-auto"
          >
      ...
      {/* Mission */}
      <section className="py-12 sm:py-24 bg-riden-surface/50">
