...
export default function ContactPage() {
  return (
    <div className="pt-20">
      {/* Hero */}
      <section className="relative py-14 sm:py-20 overflow-hidden bg-gradient-to-b from-slate-950 to-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <motion.span
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 text-blue-400 text-xs font-semibold tracking-wide border border-blue-500/20"
          >
          ...
          <motion.h1
            ...
            className="mt-5 text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white mb-4 sm:mb-5"
          >
            Let&apos;s Build Your{" "}
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-sm text-slate-400">
                      <span className="w-5 h-5 rounded-full bg-blue-500/20 text-blue-400 text-xs font-semibold flex items-center justify-center flex-shrink-0 mt-0.5">
                        {i + 1}
                      </span>
                      {s}
                    </li>
